...
public class activity_thirdquestion extends AppCompatActivity {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedContainer != null) {
                    Intent intent = new Intent(activity_thirdquestion.this, activity_fourquestion.class);
                    ...
                    Toast.makeText(activity_thirdquestion.this, "Please select an option first", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
