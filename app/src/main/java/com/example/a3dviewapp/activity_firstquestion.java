...
public class activity_firstquestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.firstactivity), (v, insets) -> {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedContainer != null) {
                    Intent intent = new Intent(activity_firstquestion.this, activity_seondquestion.class);
                    ...
                    Toast.makeText(activity_firstquestion.this, "Please select an option first", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
