...
public class activity_fourquestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.fouractivity), (v, insets) -> {
        ...
        for (final ConstraintLayout container : containers) {
            container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(activity_fourquestion.this, selectedType + " selected", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedContainer != null) {
                    Intent intent = new Intent(activity_fourquestion.this, activity_fivequestion.class);
                    ...
                    Toast.makeText(activity_fourquestion.this, "Please select an option first", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
