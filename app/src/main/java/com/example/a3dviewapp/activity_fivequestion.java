...
public class activity_fivequestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.fiveactivity), (v, insets) -> {
        ...
        for (final ConstraintLayout container : containers) {
            container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //Toast.makeText(activity_fivequestion.this, selectedType + " selected", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedContainer != null) {
                    Intent intent = new Intent(activity_fivequestion.this, activity_home.class);
                    ...
                    Toast.makeText(activity_fivequestion.this, "Please select an option first", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
