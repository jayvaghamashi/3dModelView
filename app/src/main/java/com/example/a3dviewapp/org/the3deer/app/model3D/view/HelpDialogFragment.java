package com.example.a3dviewapp.org.the3deer.app.model3D.view;
...
import com.example.a3dviewapp.org.the3deer.app.model3D.demo.EarCutDemoFragment;
import com.example.a3dviewapp.org.the3deer.app.model3D.demo.GlyphsDemoFragment;
                    ...
                    ContentUtils.showListDialog(activity, "Demos List", new String[]{"Simple Objects", "GUI", "Geometry"}, (DialogInterface dialog, int which) -> {
                        if (which == 0) {
                            ...
                            activity.getSupportFragmentManager().beginTransaction()
                                    .replace(R.id.container, modelFragment2, "demo_0")
                            ...
                            activity.getSupportFragmentManager().beginTransaction()
                                    .replace(R.id.container, modelFragment2, "demo_1")
                                    .setReorderingAllowed(true)
                                    .addToBackStack(null)
                                    .commit();
                            dismiss();
                            ...
                            activity.getSupportFragmentManager().beginTransaction()
                                    .replace(R.id.container, modelFragment2, "demo_2")
                                    .setReorderingAllowed(true)
                                    .addToBackStack(null)
                                    .commit();
                            dismiss();
